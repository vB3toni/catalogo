...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MeusPedidos.Catalogo.Presentation.Droid.Service.StubProvider, MeusPedidos.Catalogo.Presentation.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StubProvider.class, __md_methods);
	}


	public StubProvider () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StubProvider.class)
			mono.android.TypeManager.Activate ("MeusPedidos.Catalogo.Presentation.Droid.Service.StubProvider, MeusPedidos.Catalogo.Presentation.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

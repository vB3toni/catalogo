...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "MeusPedidos.Catalogo.Presentation.Droid.dll" comes first in this list. */
		"MeusPedidos.Catalogo.Presentation.Droid.dll",
		...
		"MeusPedidos.Catalogo.Core.Application.dll",
		"MeusPedidos.Catalogo.Core.CrossCutting.dll",
		"MeusPedidos.Catalogo.Core.Domain.dll",
		"SQLite.Net.dll",
		"AutoMapper.dll",
		"MeusPedidos.Catalogo.Core.Data.dll",

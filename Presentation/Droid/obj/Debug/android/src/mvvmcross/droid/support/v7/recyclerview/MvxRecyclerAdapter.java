...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Droid.Support.V7.RecyclerView.MvxRecyclerAdapter, MvvmCross.Droid.Support.V7.RecyclerView, Version=5.0.2.0, Culture=neutral, PublicKeyToken=null", MvxRecyclerAdapter.class, __md_methods);
	}
	...
	public MvxRecyclerAdapter () throws java.lang.Throwable
	{
		...
		if (getClass () == MvxRecyclerAdapter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Droid.Support.V7.RecyclerView.MvxRecyclerAdapter, MvvmCross.Droid.Support.V7.RecyclerView, Version=5.0.2.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
